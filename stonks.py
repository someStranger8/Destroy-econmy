...
# stocks
stonks = [
    "GOOGL", "F", "AAPL", "BTC", "ETH-USD", "TWTR", "SBUX", "DOGE-USD", "MSFT",
    "AMZN", "TSLA", "NVDA", "WMT", "MA", "BAC", "CVX", "HD", "KO", "COST",
    "TM", "DIS", "PEP", "ADBE", "VZ", "NKE", "INTC", "WFC", "MCD", "UPS", "T",
    "TMUS", "TXN", "PYPL", "SONY", "SHOP", "V", "PFE", "BA", "FB", "MO", "TGT",
    "ABNB", "PGR", "UBER", "NGG", "GME", "CAT", "WISH", "MDLZ", "SOFI", "RAD",
    "GM", "NXE", "HPQ", "PINS", "SNAP", "HBIO", "NFLX", "NTDOY", "^IXIC"
]
